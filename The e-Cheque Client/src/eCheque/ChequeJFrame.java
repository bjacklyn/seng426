                        ...
                        if(day.length()!=0 && month.length()!=0 && year.length()!=0){
                            ...
                            if(signPass.hashCode()==eChequeReg.getPasword()){
                                ...
                                try{
                                   ...
                                   InputStream in = new FileInputStream(eChequeReg.getEWalletLoaction()+ File.separator +"Security Tools" + File.separator + "Private Key.key");
                                   OutputStream out = new FileOutputStream(eChequeReg.getEWalletLoaction()+ File.separator + "Security Tools"+ File.separator +"PrivateKey.key"); 
                                   
                                   // decrypt the private key with the AES key and delete the plain key
                                   aesCrypt.crypt(in,out,cipher);
                                   in.close();
                                   out.close();
                                   ObjectInputStream objIn = new ObjectInputStream (new FileInputStream(eChequeReg.getEWalletLoaction()+ File.separator +"Security Tools"+File.separator+"PrivateKey.key"));
                                   ...
                                   File control = new File(eChequeReg.getEWalletLoaction()+ File.separator +"Security Tools"+ File.separator +"PrivateKey.key");
                                   control.delete();
                                   ...
                                   drawCheque.savecheque(chequeObj,eChequeReg.getEWalletLoaction()+ File.separator +"My Cheques" + File.separator+chequeObj.getchequeNumber()+".sec");
