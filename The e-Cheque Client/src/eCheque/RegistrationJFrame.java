...
// TODO add your handling code here:
        ...
        File wallet;
        wallet= new File(eWalletPath+File.pathSeparator+"In Coming");
        wallet.mkdirs();
        wallet= new File(eWalletPath+File.pathSeparator+"Out going");
        wallet.mkdirs();
        wallet = new File(eWalletPath+File.pathSeparator+"Security Tools ");
        wallet.mkdirs();
        wallet = new File(eWalletPath+File.pathSeparator+"My Cheques ");
        wallet.mkdirs();
        wallet = new File(eWalletPath+File.pathSeparator+"History ");
        wallet.mkdirs();
                                                ...
                                                if(password.length >= 8 && password.length <16)
                                                {
                                                    if(pathFlag){
                                                        ...
                                                        try {
                                                            ...
                                                            outObj = new ObjectOutputStream(new FileOutputStream(eWalletPath+File.pathSeparator+"Security Tools"+File.pathSeparator+"privateKey.key"));
                                                            ...
                                                            InputStream in = new FileInputStream(eWalletPath+File.pathSeparator+"Security Tool"+File.pathSeparator+"privateKey.key");
                                                            OutputStream out = new FileOutputStream(eWalletPath+File.pathSeparator+"Security Tools"+File.pathSeparator+"Private Key.key"); 
                                                            
                                                            // encrypt the private key with the AES key and delete the plain key
                                                            aesCrypt.crypt(in,out,cipher);
                                                            in.close();
                                                            out.close();
                                                            File control = new File(eWalletPath+File.pathSeparator+"Security Tools"+File.pathSeparator+"privateKey.key");
                                                            control.delete();
                                                            ...
                                                            dcIO.SaveDC(dcObj,eWalletPath+File.pathSeparator+"Security Tools"+File.pathSeparator+registerationObj.getClientName()+"DigCert.edc");
