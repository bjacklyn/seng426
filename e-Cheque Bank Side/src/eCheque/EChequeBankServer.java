...
public class EChequeBankServer extends javax.swing.JFrame {
	...
	private void initComponents() {
		...
		java.awt.Dimension screenSize = java.awt.Toolkit.getDefaultToolkit()
				.getScreenSize();
		setBounds((screenSize.width - 306) / 2, (screenSize.height - 271) / 2,
				306, 271);
	...
	private void jBStopMouseClicked(java.awt.event.MouseEvent evt) {// GEN-FIRST:event_jBStopMouseClicked
		if (serverStartFlag) {
			...
			JOptionPane.showMessageDialog(null, "The Server is not working",
					"System Information", JOptionPane.INFORMATION_MESSAGE);
		}
	...
	private void jBStartMouseClicked(java.awt.event.MouseEvent evt) {// GEN-FIRST:event_jBStartMouseClicked
		if (!serverStartFlag) {
			...
			JOptionPane.showMessageDialog(null, "The Server is aready running",
					"System Information", JOptionPane.INFORMATION_MESSAGE);
